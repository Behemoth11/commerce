...
const useFocus = () => {
  ...
  const depth = (0,external_react_.useRef)(0);

  const open = (id, direction, cb) => {
...
const MyWindowContext = /*#__PURE__*/(0,external_react_.createContext)({
  ...
  hashLocation: "",
  setHashLocation: (id, direction, cb) => console.log(0)
});
const useMyWindow = () => {
...
/* harmony export */ });
/* unused harmony exports useIsomorphicLayoutEffect, useScreenSize, useRequire */
