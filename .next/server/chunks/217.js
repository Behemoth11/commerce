...
/* harmony export */ });
/* harmony import */ var _style_module_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(1629);
...
const Popup = ({
  ...
  return animate((_style, _isVisible) => _isVisible && /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx("div", {
    className: `${(_style_module_scss__WEBPACK_IMPORTED_MODULE_4___default().container)} ${(_style_module_scss__WEBPACK_IMPORTED_MODULE_4___default())[type]} ${!visibility && (_style_module_scss__WEBPACK_IMPORTED_MODULE_4___default().notVisible)}`,
    children: /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx(react_spring__WEBPACK_IMPORTED_MODULE_1__.animated.div, {
      className: (_style_module_scss__WEBPACK_IMPORTED_MODULE_4___default().popupContainer),
      children: /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx(react_spring__WEBPACK_IMPORTED_MODULE_1__.animated.div, {
        style: _style,
        className: `${(_style_module_scss__WEBPACK_IMPORTED_MODULE_4___default())[type]} ${(_style_module_scss__WEBPACK_IMPORTED_MODULE_4___default().content)}z`,
        children: children
      })
    })
  }));
...
// Exports
module.exports = {
	"container": "style_container__3frNv",
	"popupContainer": "style_popupContainer__xvHNv",
	"content": "style_content__2xU31",
	"overlay": "style_overlay__1y2AR",
	"notVisible": "style_notVisible__NO9Yy"
};
