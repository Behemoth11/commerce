...
const handler = async (req, res) => {
  switch (req.method) {
    case "GET":
      await (0,_api_handlers_product__WEBPACK_IMPORTED_MODULE_0__/* .GET_WITH_REPRESENTATION_handler */ .ip)(req, res);
      break;
...
var __webpack_exports__ = __webpack_require__.X(0, [460,35,334,641,293,504], () => (__webpack_exec__(4012)));
