...
const about = () => {
  ...
  useEffect(() =>{
    ...
    _next.style.scrollBehavior = "smooth"

    return () =>{ _next.style.scrollBehavior = "auto"};
  }, [])
  return (
    <div
    ...
    >
      <div className={styles.content}>
        ...
        <Header level={1} id="privacy policy">
          Privacy policy
        </Header>
        <p>
          <u>Last updated:</u> December 01, 2021
        </p>
        <p>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to KdShop, KdShop.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Country</strong> refers to: Gabon
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to KdShop, accessible from
              <a
                href="https://commerce-three-pi-20.vercel.app/"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://commerce-three-pi-20.vercel.app/
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>
            <p>
              ...
              <a
                ...
                data-cfemail="7a111e0912150a1d1b1815143a1d171b131654191517"
              >
                [email&#160;protected]
              </a>
            </p>
          ...
          <li>
            <p>
              ...
              <a
                href="http://commerce-three-pi-20.vercel.app"
                rel="external nofollow noopener"
                target="_blank"
              >
                http://commerce-three-pi-20.vercel.app
              </a>
            </p>
          </li>
          <li>
            <p>By phone number: +1 (531) 225-6403</p>
          </li>
        </ul>

        <Header level={1} id="terms and condition">
          Terms and conditions
        </Header>

        <div>
          <h4>Terms and Conditions</h4>
          <p>Welcome to KdShop!</p>
          <p>
            These terms and conditions outline the rules and regulations for the
            use of KdShop's Website, located at
            https://commerce-three-pi-20.vercel.app/.
          </p>
          <p>
            By accessing this website, we assume you accept these terms and
            conditions. Do not continue to use KdShop if you do not agree to
            take all of the terms and conditions stated on this page.
          </p>
          <h4>Cookies:</h4>
          <p>
            The website uses cookies to help personalize your online experience.
            By accessing KdShop, you agreed to use the required cookies.
          </p>
          <p>
          ...
          <h4>License:</h4>
          <p>
            Unless otherwise stated, KdShop and/or its licensors own the
            intellectual property rights for all material on KdShop. All
            intellectual property rights are reserved. You may access this from
            KdShop for your own personal use subjected to restrictions set in
            these terms and conditions.
          </p>
          <p>You must not:</p>
          <ul>
            <li>Copy or republish material from KdShop</li>
            <li>Sell, rent, or sub-license material from KdShop</li>
            <li>Reproduce, duplicate or copy material from KdShop</li>
            <li>Redistribute content from KdShop</li>
          </ul>
          <p>This Agreement shall begin on the date hereof.</p>
          <p>
            Parts of this website offer users an opportunity to post and
            exchange opinions and information in certain areas of the website.
            KdShop does not filter, edit, publish or review Comments before
            their presence on the website. Comments do not reflect the views and
            opinions of KdShop, its agents, and/or affiliates. Comments reflect
            the views and opinions of the person who posts their views and
            opinions. To the extent permitted by applicable laws, KdShop shall
            not be liable for the Comments or any liability, damages, or
            expenses caused and/or suffered as a result of any use of and/or
            posting of and/or appearance of the Comments on this website.
          </p>
          <p>
            KdShop reserves the right to monitor all Comments and remove any
          ...
          <p>
            You hereby grant KdShop a non-exclusive license to use, reproduce,
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of KdShop; and
          ...
          <p>
            ...
            sending an e-mail to KdShop. Please include your name, your
          ...
          <p>
            No use of KdShop's logo or other artwork will be allowed for linking
